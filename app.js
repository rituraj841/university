...
app.all('*', function(req, res, next){
	...
	if (req.session.authenticated){
		...
		if ((req.path === "/")
			...
			|| (req.path === "/register-form")
			|| (req.path === "/register-submit")
		){
...
app.get('/', routes.indexHandler); //Serves Default or index page to the client
app.get('/login', routes.loginFormHandler); //Serves Default or index page to the client
...
app.get('/adminDashboard', routes.adminDashboardHandler);
